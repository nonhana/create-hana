...
sources: []
links: ["generator-extension-rules.md", "verification-baseline-2026-07-14.md", "effect-vnext-refactor-design.md"]
...
The proposed replacement architecture is recorded separately in [[effect-vnext-refactor-design]]. This page continues to describe the legacy engine until vNext becomes the released default.
