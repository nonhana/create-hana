...
sources: []
links: ["generation-architecture.md", "effect-vnext-refactor-design.md"]
category: convention
confidence: medium
schemaVersion: 1
---
...
These rules apply to the legacy engine. The proposed first-party Module extension contract is documented in [[effect-vnext-refactor-design]].
